...
Use the **"Add card"** dropdown above the main grid to search and select a card, then click **Add card**. To remove cards, select them in the **"Remove cards"** list and click **Remove selected**.
